...
@section('content')
    <div class="card">
        <div class="card-header">
            <a href="{{route('admin.users.create')}}"class="btn btn-primary btb-sm"> Registrar Usuario</a>
        </div>
    </div>
                ...
                <tr>
                  ...
                  <td>
                    <form action="{{route('admin.users.destroy', $usuario)}}" method="post">
                      ...
                      <a href="{{route('admin.users.edit',$usuario)}}" class="btn btn-info btn-sm">Editar</a>
