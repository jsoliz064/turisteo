		...
		{{-- <div class="row justify-content-center border border-primary rounded-top">
			<div class="col justify-content-center">
				...
				<div class="row justify-content-center mt-2 text-center">
					<div class="col">
						<h3 class="font-weight-bold">EMPRESA "NOMBRE"</h3>
					</div>
				</div>
        ...
        <div class="row justify-content-center border border-primary rounded-top">
			<div class="col justify-content-center">
				...
				<div class="row  align-items-center justify-content-between">
					<div class="col-4">
						<h5><b>Fecha de Emision: </b>{{$pago->updated_at}} </h5>
					</div>
					<div class="col-4">
						<h5><b>NIT: </b> </h5>
					</div>
                ...
                <div class="row  align-items-center justify-content-between">
					<div class="col-4">
						<h5><b>Cliente: </b>{{$socio->nombre}} </h5>
					</div>
					<div class="col-4">
						<h5><b>C.I: </b>{{$socio->ci}}</h5>
					</div>
				</div>
				<div>
				...
				<div class="row  align-items-center justify-content-between">
					<div class="col-4">
						<h5><b>TOTAL: </b>Bs {{$pago->total}}</h5>
					</div>
					{{-- <div class="col-4">
						<h5>Codigo Control:</h5>
					</div> --}}
				</div>
			</div>
		</div>
